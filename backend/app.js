...
app.post("/uploadPicture", verifyToken, async (req, res) => {
  User.findOneAndUpdate({ username: req.verifiedUser.username }, { profilePicture: req.body.picture }, async (err, user) => {
    res.send("Update Done");
  });
});
